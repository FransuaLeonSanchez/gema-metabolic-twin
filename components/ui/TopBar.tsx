...
export function TopBar({
  ...
  return (
    <div className="flex items-center justify-between px-1 py-1 mb-2">
      <button
        onClick={onBack}
        className="w-9 h-9 rounded-full bg-black/[0.035] border border-black/[0.08] flex items-center justify-center active:scale-95 transition disabled:opacity-30"
        disabled={!onBack}
        aria-label="Atrás"
      >
