...
const SLOTS: {
  ...
  { type: "Desayuno", icon: Coffee, hint: "07:00–09:00", color: "#D97706" },
  { type: "Almuerzo", icon: Soup,   hint: "12:30–14:00", color: "#0284C7" },
  { type: "Cena",     icon: Moon,   hint: "19:00–21:00", color: "#7C3AED" },
      ...
      <div className="flex flex-col h-full px-5 pb-5">
        ...
        <div className="flex items-center justify-between py-2">
          <button
            ...
            className="w-9 h-9 rounded-full bg-card border border-black/[0.08] flex items-center justify-center active:scale-95"
            aria-label="Cerrar"
          >
        ...
        {stage === "options" && (
          <>
            ...
            <div className="mt-auto pt-4">
              <div className="rounded-[20px] bg-card2 border border-black/[0.08] p-3 flex items-start gap-2.5">
        ...
        {(stage === "camera" || stage === "analyzing" || stage === "detected") && (
          <>
            <div className="relative aspect-square w-full rounded-3xl overflow-hidden bg-card2 border border-black/[0.08]">
              ...
              {stage === "camera" && !photo && (
                <span className="absolute top-3 left-3 px-2 py-1 rounded-full bg-black/60 text-[10px] text-white font-bold flex items-center gap-1">
              ...
              {stage === "analyzing" && (
                <div className="absolute inset-0 bg-black/55 flex items-center justify-center">
                  <div className="bg-card border border-black/[0.08] rounded-[20px] px-4 py-2 flex items-center gap-2 shadow-soft">
        ...
        {stage === "denied" && (
          <div className="rounded-3xl bg-card2 border border-black/[0.08] p-6 flex flex-col items-center text-center gap-3">
  ...
  return (
    <div className="h-full overflow-y-auto scroll-hide px-5 pt-2 pb-[110px] relative">
      ...
      <Card>
        ...
        <Sparkline data={glucoseDay} color="#0284C7" height={70} showAxis={false} />
        ...
        {SLOTS.map((s) => {
          ...
          return (
            <button
              ...
              className="w-full text-left bg-card border border-black/[0.08] rounded-[20px] p-3 active:scale-[0.99] transition"
              style={{ borderLeft: `3px solid ${meal ? s.color : "#E3E8F1"}` }}
            >
              <div className="flex items-center gap-3">
                <div className="relative w-14 h-14 rounded-[20px] overflow-hidden bg-card2 border border-black/[0.08] flex items-center justify-center shrink-0">
                  {meal?.photo ? (
                    // eslint-disable-next-line @next/next/no-img-element
...
function OptionCard({
  ...
  return (
    <button
      onClick={onClick}
      className="w-full bg-card border border-black/[0.08] rounded-[20px] p-4 flex items-start gap-3 active:scale-[0.99] transition text-left"
...
function Stat({ label, value, color }: { label: string; value: string; color: string }) {
  return (
    <div className="bg-card2 border border-black/[0.08] rounded-xl p-2 text-center">
...
function DayStat({
  ...
  return (
    <div className="rounded-xl bg-card2 border border-black/[0.08] px-2.5 py-2">
